...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        focusedDate = currentDate = Calendar.getInstance(); // Returns instance with current date and time set
  ...
  /*      if (cursor.moveToFirst()){
    ...
    public void previousDay(View view)
    {
        ...
        else if (focusedDate.get(Calendar.MONTH)==1 && focusedDate.get(Calendar.DAY_OF_MONTH)==1) focusedDate.set(Calendar.YEAR,0,31);
